...
replace github.com/gflydev/modules/storages3 => ../

require github.com/gflydev/modules/storages3 v1.0.3
...
require (
	...
	github.com/gflydev/storage/s3 v1.1.4 // indirect
	github.com/gflydev/validation v1.0.2 // indirect
