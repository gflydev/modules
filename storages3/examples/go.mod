...
require github.com/gflydev/modules/storages3 v1.0.1
...
require (
	...
	github.com/gflydev/modules/storage v1.0.2 // indirect
	github.com/gflydev/storage v1.1.0 // indirect
	github.com/gflydev/storage/local v1.1.0 // indirect
	github.com/gflydev/validation v1.0.0 // indirect
